...
function showingMiddleAge(gender) {
...
// showingMiddleAge — функция отображения актуальных данных для выбранного возраста, в качестве аргумента в которую мы передаём выбраный пол (gender).
// С помощью этой функции мы, если женский пол выбран — if (gender) — подставляем в элемент справа от таблицы с кружками среднюю продолжительность жизни женщин, а если не выбран, то мужчин.